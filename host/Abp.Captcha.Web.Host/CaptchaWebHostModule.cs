...
namespace MaigcalConch.Abp.Captcha
{
    ...
    public class CaptchaWebHostModule : AbpModule
    {
        ...
        private void ConfigureMenu(IConfiguration configuration)
        {
            ...
            {
                options.MenuContributors.Add(new CaptchaWebHostMenuContributor(configuration));
            });
        }
        ...
        private void ConfigureAutoMapper()
        {
            ...
            {
                options.AddMaps<CaptchaWebHostModule>();
            });
        }
