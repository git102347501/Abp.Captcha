...
describe('AppComponent', () => {
  ...
  it(`should have as title 'abp-captcha'`, () => {
    const fixture = TestBed.createComponent(AppComponent);
    const app = fixture.componentInstance;
    expect(app.title).toEqual('abp-captcha');
  });
  ...
  it('should render title', () => {
    ...
    expect(compiled.querySelector('.content span').textContent).toContain('abp-captcha app is running!');
  });
});
